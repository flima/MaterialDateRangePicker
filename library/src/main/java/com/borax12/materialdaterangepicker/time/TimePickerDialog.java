...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener {
    ...
    private static final String KEY_FIRST_TAB_INDICATOR = "first_tab_indicator";
    private static final String KEY_SECOND_TAB_INDICATOR = "second_tab_indicator";
    ...
    private String mFistTabIndicator = "FROM";
    private String mSecondTabIndicator = "TO";
    ...
    public void setFistTabIndicator(String fistTabIndicator) {
        this.mFistTabIndicator = fistTabIndicator;
    }

    public void setSecondTabIndicator(String secondTabIndicator) {
        this.mSecondTabIndicator = secondTabIndicator;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(KEY_HOUR_OF_DAY)
            ...
            mFistTabIndicator = savedInstanceState.getString(KEY_FIRST_TAB_INDICATOR);
            mSecondTabIndicator = savedInstanceState.getString(KEY_SECOND_TAB_INDICATOR);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        startDatePage.setIndicator(mFistTabIndicator);

        TabHost.TabSpec endDatePage = tabHost.newTabSpec("end");
        endDatePage.setContent(R.id.end_date_group);
        endDatePage.setIndicator(mSecondTabIndicator);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        if (mTimePicker != null) {
            ...
            outState.putString(KEY_FIRST_TAB_INDICATOR, mFistTabIndicator);
            outState.putString(KEY_SECOND_TAB_INDICATOR, mSecondTabIndicator);
        }
    }
